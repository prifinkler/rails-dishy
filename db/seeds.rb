...
margarita_pizza = Recipe.create!(
  ...
  instruction: 'Preheat your oven to 475°F (245°C).
                ...
                Sprinkle with fresh basil leaves and a drizzle of olive oil.
                Bake in the oven for 10-12 minutes or until the crust is golden and the cheese is bubbly.
                Slice and serve hot.'
)
...
stir_fried_chicken_with_broccoli = Recipe.create!(
  ...
  instruction: 'Heat oil in a pan or wok over high heat.
                Add diced chicken and stir-fry until cooked through.
                Remove the chicken and set it aside.
                In the same pan, stir-fry broccoli florets until they turn bright green.
                Return the chicken to the pan.
                Add soy sauce, garlic, and ginger. Stir-fry for an additional 2 minutes.
...
vegetable_curry = Recipe.create!(
  ...
  instruction: 'Heat oil in a large pot and sauté onions until translucent.
                Add garlic, ginger, and curry paste. Cook for 2 minutes.
                Stir in diced vegetables (e.g., carrots, bell peppers, and potatoes).
...
sushi_rolls = Recipe.create!(
  ...
  instruction: 'Place a sheet of nori on a bamboo sushi mat.
                Spread a layer of sushi rice over the nori, leaving a border at the top.
                Add your choice of fillings (e.g., avocado, cucumber, and cooked shrimp).
...
ratatouille = Recipe.create!(
  ...
  instruction: 'Heat olive oil in a large pot.
                ...
                Add diced tomatoes, eggplant, zucchini, and herbs.
...
greek_salad = Recipe.create!(
  ...
  instruction: 'In a large bowl, combine diced cucumbers, tomatoes, and red onions.
...
pad_thai = Recipe.create!(
  ...
  instruction: 'Soak rice noodles in hot water until softened, then drain.
                Heat oil in a wok or large pan.
                Add shrimp and tofu; cook until shrimp turns pink.
                Push ingredients to one side and scramble eggs in the pan.
                Add noodles, followed by tamarind sauce, fish sauce, and sugar.
                Stir-fry until well mixed.
                Add bean sprouts and chopped peanuts.
...
spanish_paella = Recipe.create!(
  ...
  instruction: 'Heat olive oil in a paella pan.
                Sauté onions, garlic, and bell peppers.
                Add diced chicken and cook until browned.
                Stir in saffron, paprika, and rice; cook for 2 minutes.
                Pour in chicken broth and simmer for 20 minutes.
                Add seafood (e.g., shrimp, mussels) and peas.
                Cover and cook until seafood is cooked through.
...
bbq_pulled_pork_sandwich = Recipe.create!(
  ...
  instruction: 'Rub pork shoulder with a dry spice rub.
                Slow-cook the pork in a smoker or oven at low heat for 8 hours.
...
vegetable_sushi_bowl = Recipe.create!(
  ...
  instruction: 'Cook sushi rice according to package instructions and let it cool.
                Arrange sushi rice in bowls.
                Top with sliced avocado, cucumber, carrots, and pickled ginger.
                Drizzle with soy sauce and sesame seeds.
                Serve as a healthy and colorful meal.'
)
...
aubergine_with_black_garlic_recipe = Recipe.create!(
  ...
  instruction: 'Preheat the oven to 250°C/480°F/gas 9 (or its highest setting).
                In a large bowl, mix aubergine rounds with 60ml of olive oil, 1½ tsp salt, and black pepper.
                Spread the aubergine slices on two large baking trays lined with greaseproof paper.
                Roast in the oven until golden-brown and completely soft, about 30 minutes.
                Remove from the oven and let them cool.
                In a small food processor, blend the BLACK GARLIC CLOVES with 1/3 tsp salt, 2 tbsp olive oil, 2 tbsp yogurt, and lemon juice to form a rough paste.
                Transfer the paste to a medium bowl and mix in the remaining yogurt. Chill in the fridge.
                Heat the remaining 110ml of oil in a small saucepan over high heat.
                Add sliced garlic and chilli and fry on medium heat for about 5 minutes until golden-brown and crispy.
                Use a slotted spoon to transfer the garlic and chilli to a paper-lined plate.
                Arrange the roasted aubergine slices on a platter.
                Spoon the black garlic sauce over the aubergine.
                Sprinkle the crispy garlic and chilli over the top.
                Finish by garnishing with dill, basil, and tarragon leaves.
...
pappardelle_recipe = Recipe.create!(
  ...
  instruction: 'Heat olive oil in a large sauté pan with a lid over medium-high heat.
                Add thinly sliced onion and fry for 8 minutes, stirring occasionally, until soft and caramelized.
                Stir in ROSE HARISSA, cherry tomatoes, torn Kalamata olives, capers, and ½ teaspoon of salt.
                Continue to fry for 3–4 minutes, stirring frequently, until the tomatoes start to break down.
                Add 200ml of water and stir.
                Bring to a boil, then reduce the heat to medium-low, cover, and simmer for 10 minutes.
                Remove the lid and continue to cook for 4–5 minutes, until the sauce is thick and rich.
                Stir in 10g of parsley and set aside.
                In a large pot, boil salted water and cook the pappardelle according to the packet instructions until al dente.
                Drain well.
                Return the pasta to the pot and add harissa sauce and 1/8 teaspoon of salt. Mix together.
                Divide the pasta among four shallow bowls.
                Serve hot with a spoonful of Greek-style yoghurt and a final sprinkle of parsley.'
)
...
koftas_recipe = Recipe.create!(
  ...
  instruction: 'Put the chicken thighs in a food processor and pulse until minced.
                Transfer the minced chicken to a large bowl and add grated onion, crushed garlic, grated tomato (skin discarded), chopped parsley, lemon zest, 1 tbsp olive oil, 3/4 tsp salt, and a good grind of pepper.
                Knead the mixture for about three minutes until well combined and sticky.
                Divide into 12 portions and form them into compact, torpedo-shaped koftas of about 55g each.
                Make the rub by combining finely ground coffee, ground cascabel chilli, soft light brown sugar, smoked paprika, and ground cumin with 1/2 tsp salt.
                Set aside one-third of the rub mixture and spread the rest over a baking tray.
                Roll each kofta in the coffee rub until well coated and set aside (or refrigerate if preparing ahead).
                Preheat the oven to 240°C (220°C fan)/475°F/gas Toss the red onion rounds with 1 tbsp oil, 1/4 tsp salt, and pepper.
                Grill the onion slices in a well-greased griddle pan on a high heat for four minutes on each side until well charred and softened, then set aside to cool.
                Drizzle the koftas with 1 tbsp oil and grill them in two batches for about 90 seconds per batch until lightly charred on the outsides.
                Transfer the grilled kofta to a medium oven tray lined with greaseproof paper and roast in the hot oven for six minutes.
                Combine the reserved coffee rub with two tablespoons of oil and drizzle it all over the kofta.
                Return to the oven for another three minutes until cooked through and nicely browned.
                In a bowl, toss the grilled onion with mint, picked parsley, lemon juice, and a pinch of salt and pepper.
                Arrange the koftas and their cooking juices on a platter and pile the grilled onion salad to one side.
                Squeeze the lemon wedges over the koftas and serve warm.'
)
...
jollof_rice_recipe = Recipe.create!(
  ...
  instruction: 'Put all the puree ingredients in a food processor, except the scotch bonnets, if using whole, and whizz into a thick and aromatic puree.
                Put the oil in a wide large saucepan, for which you have a tightly fitting lid, and set over a medium heat.
                Add the red onion and a pinch of fine sea salt.
                Cook for 15 minutes, stirring often, until softened and golden.
                If it starts to get dry, add a little splash of water to prevent the onion from burning.
                ...
                Gently pour in the blended puree, stirring well, then cover and cook for up to 25 minutes, until the puree is reduced to a drier sauce.
                Keep a close eye on it and stir occasionally.
                Add the rice and stock (about 250ml for basmati rice and up to 400ml for long-grain rice), ensuring there is enough water to just submerge the rice.
                Season with the fine sea salt and stir just once. Add the scotch bonnets, if using whole.
                Bring to a boil, then reduce the heat, cover, and simmer over a low-medium heat for up to 30 minutes.
                The sauce must be visibly simmering to ensure the rice cooks properly.
                Once the rice is cooked, remove the pan from the heat and leave covered to steam for a few minutes.
                Fluff with a fork, scatter over the reserved thyme leaves, and enjoy your wonderful creation with a fresh salad and/or fried plantains, because jollof and plantains are a match made in heaven.'
)
...
scully_pork_belly = Recipe.create!(
  ...
  instruction: "Heat the oven to 250°C/Gas Mark 10 or its highest setting.
                Place the herbs, garlic, and olive oil in a heavy-duty blender or food processor and roughly purée them.
                Lay the pork belly in an oven tray, skin-side down, and lightly sprinkle with salt and pepper.
                Spread the herb mixture evenly over the top, pressing it onto the meat.
                Turn the belly skin-side up, dry the skin with kitchen paper, and sprinkle sea salt evenly over the skin (avoid using too much).
                Place the tray in the oven and roast for 1 hour, turning it every 20 minutes.
                Once the skin starts forming crackling, reduce the oven temperature to 170°C/Gas Mark 3, pour the white wine into the tray (avoiding the pork skin), and continue roasting for another hour.
                If the belly starts turning black, cover it with foil.
                For the final stage, reduce the oven temperature to 110°C/Gas Mark ¼ and continue roasting for another hour, until the skin has completely crackled and dried.
                Remove the pork from the oven.
                Use a sharp knife to divide it into segments of a few ribs, cutting between the rib bones. Serve with seasonal relishes on the side."
)
...
african_roasted_vegetables = Recipe.create!(
  ...
  instruction: 'Preheat the oven to 400°F (200°C).
                Toss eggplant, zucchini, tomatoes, and onions with olive oil, salt, pepper, and dried oregano.
                Roast in the oven until vegetables are tender and slightly caramelized.
                Serve as a side dish with feta cheese and a drizzle of extra virgin olive oil.'
)
...
shrimp_pad_thai = Recipe.create!(
  ...
  instruction: 'Cook rice noodles according to package instructions.
                In a wok, heat vegetable oil and stir-fry shrimp until pink.
                Add garlic, tofu, and beaten egg.
                Stir in a sauce made of tamarind paste, soy sauce, and sugar.
                Toss in cooked noodles, bean sprouts, and chopped peanuts.
...
chicken_and_rice_pilaf = Recipe.create!(
  ...
  instruction: 'Season chicken thighs with salt, pepper, and ROSE HARISSA spice rub.
                In a large skillet, heat olive oil and brown chicken.
                Add garlic cloves, diced tomatoes, and ground cumin.
...
vegetable_stir_fry = Recipe.create!(
  ...
  instruction: 'Heat vegetable oil in a wok.
                Stir-fry tofu until lightly browned.
                Add garlic, sliced bell peppers, and onions.
                Toss in zucchini, snap peas, and soy sauce.
...
shrimp_scampi = Recipe.create!(
  ...
  instruction: 'Cook linguine pasta according to package instructions.
                In a skillet, melt butter and sauté garlic until fragrant.
                Add shrimp and cook until pink.
                Toss in cooked pasta, lemon juice, and parsley.
                Season with salt and pepper.'
)
...
cabbage_carrot_slaw = Recipe.create!(
  ...
  instruction: 'Shred cabbage and carrots.
                In a bowl, mix mayonnaise, vinegar, sugar, and mustard.
                Toss the shredded vegetables with the dressing.
...
minty_yogurt_sauce = Recipe.create!(
  ...
  instruction: 'Finely chop fresh mint leaves.
                Mix mint with Greek-style yogurt.
                Season with salt and pepper.
...
coffee_rubbed_pork = Recipe.create!(
  ...
  instruction: 'Mix ground coffee, Cascabel chili, brown sugar, smoked paprika, ground cumin, and salt.
                Rub the spice mixture all over the pork shoulder.
                Roast in the oven until tender and caramelized.
                Serve with black garlic aioli.'
)
...
japanese_sushi_bowl = Recipe.create!(
  ...
  instruction: 'Cook sushi rice according to package instructions.
                Arrange sushi rice in bowls.
                Top with sliced avocado, cucumber, and cooked shrimp.
                Drizzle with soy sauce and garnish with pickled ginger and sesame seeds.'
)
...
mediterranean_aubergine_salad = Recipe.create!(
  ...
  instruction: 'Grill Aubergine slices until tender and slightly charred.
                Combine grilled Aubergine, cherry tomatoes, red onion, and feta cheese.
...
thai_basil_shrimp = Recipe.create!(
  ...
  instruction: 'Heat vegetable oil in a pan and stir-fry garlic and chili peppers.
                Add shrimp and cook until pink.
                Toss in fresh basil leaves and a sauce made of soy sauce, fish sauce, sugar, and lime juice.
                Serve over rice.'
)
...
indian_butter_chicken = Recipe.create!(
  ...
  instruction: 'Marinate chicken thighs in yogurt, ginger, garlic, and spices.
                Grill or pan-fry the chicken until cooked.
                Simmer in a tomato-based sauce with butter and cream.
...
mediterranean_roasted_vegetables = Recipe.create!(
  ...
  instruction: 'Toss eggplant, zucchini, tomatoes, onions, and garlic with olive oil and spices.
...
mediterranean_grilled_chicken = Recipe.create!(
  ...
  instruction: 'Marinate chicken breasts in olive oil, garlic, lemon juice, oregano, and thyme.
                Grill until cooked through and slightly charred.
                Serve with a side of Greek Tzatziki Sauce and roasted vegetables.'
)
...
japanese_teriyaki_tofu = Recipe.create!(
  ...
  instruction: 'Press tofu to remove excess moisture, then cut into cubes.
                Pan-fry tofu until golden brown.
                Coat with homemade teriyaki sauce made from soy sauce, sugar, and ginger.
...
italian_salad = Recipe.create!(
  ...
  instruction: 'Combine cucumbers, cherry tomatoes, red onion, Kalamata olives, and feta cheese.
                Drizzle with extra virgin olive oil, lemon juice, and sprinkle dried oregano.
                Season with salt and pepper.'
)
...
thai_red_curry_shrimp = Recipe.create!(
  ...
  instruction: 'Cook shrimp in a pan, then set aside.
                Sauté bell peppers, garlic, and onions.
                Add red curry paste, coconut milk, and fish sauce.
                Simmer and return shrimp to the sauce.
                Serve over rice.'
)
...
barbecue_pulled_pork_sliders = Recipe.create!(
  ...
  instruction: 'Rub pork shoulder with barbecue spice rub.
                Slow-cook the pork until tender.
                Shred the pork and mix with barbecue sauce.
                Serve in hamburger buns with coleslaw.'
)
...
sushi_rice_bowl_avocado = Recipe.create!(
  ...
  instruction: 'Cook sushi rice according to package instructions and let it cool.
                ...
                Top with sliced avocado and drizzle with soy sauce and sesame seeds.'
)
...
minty_greek_tzatziki_sauce = Recipe.create!(
  ...
  instruction: 'Grate cucumber and squeeze out excess moisture.
                Mix grated cucumber with Greek yogurt, garlic, mint, and lemon juice.
                Season with salt and pepper.'
)
...
spicy_mediterranean_aubergine_dip = Recipe.create!(
  ...
  instruction: 'Roast Aubergine until tender and charred.
                Blend with tahini, lemon juice, garlic, cumin, and red pepper flakes.
...
garlic_herb_mashed_potatoes = Recipe.create!(
  ...
  instruction: 'Boil potatoes until tender, then mash with butter, garlic, and herbs.
...
sesame_crusted_tuna_steak = Recipe.create!(
  ...
  instruction: 'Coat tuna steak with sesame seeds and sear in a hot pan.
                Serve with a soy-ginger dipping sauce and steamed broccoli.'
)
...
lamb_pistachio_patties = Recipe.create!(
  ...
  instruction: 'Mix together Greek-style yogurt, sumac, olive oil, and lemon juice. Keep in the fridge until needed.
                Put shelled pistachios in a food processor and blitz until roughly chopped. Transfer to a medium bowl.
                Add arugula to the processor and blitz until roughly chopped. Add to the bowl with pistachios.
                Process onion and garlic until a smooth paste forms, then add to the bowl.
                Add ground lamb, 1 tablespoon of olive oil, 3/4 teaspoon of salt, and a good grind of pepper to the bowl. Mix well.
                With wet hands, shape the mixture into about 20 patties, each about 2 inches wide, 3/4 inch thick, and weighing about 1 1/2 ounces.
                Heat 1 tablespoon of olive oil in a large nonstick frying pan over medium heat.
                Cook the patties for 7 minutes, turning about 3 1/2 minutes, until golden brown and cooked through.
                Keep warm while cooking the remaining patties. Add more oil if needed.
                Pile the cooked patties onto a large platter and serve with the sumac yogurt sauce.'
)
...
curried_cauliflower_pie = Recipe.create!(
  ...
  instruction: 'Preheat the oven to 180°C fan. Line the bottom and sides of a 23cm springform cake tin with baking parchment.
                Toss cauliflower with 2 tsp mild curry powder, 3 tbsp olive oil, ½ teaspoon of salt, and a good grind of pepper.
                Roast for about 20 minutes, until cooked through and lightly colored. Set aside, and turn the oven temperature down to 170°C fan.
                Meanwhile, make the béchamel.
                Put the cubed butter (100g) into a medium saucepan on a medium-high heat and, once melted, whisk in the plain flour (75g) and cook for 1–2 minutes – it should start to smell nutty (like popcorn).
                Turn the heat down to medium and slowly add the whole milk (675ml) a little at a time, whisking continuously to prevent any lumps, until incorporated and the sauce is smooth.
                Cook, whisking often, for about 7 minutes, until thickened slightly. Off the heat, stir in the crushed garlic (2 cloves), English mustard (1½ tbsp), and mature cheddar (150g) until the cheese has melted.
                Keep your filo sheets under a damp tea towel to prevent them from drying out. In a bowl, combine the melted butter (50g) and the remaining 1½ tablespoons of olive oil and keep to one side.
                Working one sheet at a time, brush the exposed side of the filo with the butter mixture and drape it into your prepared tin (buttered side up), pushing it down gently to fit.
                Continue in this way with the next filo sheet, brushing it with butter and then laying it over the bottom sheet, rotating it slightly so the overhang drapes over the sides at a different angle.
                Do this with all six sheets.
                Spoon half the béchamel into the base and top with the roasted cauliflower florets.
                Spoon over the remaining béchamel, then crimp up the overhang so that it creates a messy ‘scrunched-up’ border around the edges, leaving the center of the pie exposed.
                ...
                Using a tea towel to help you, carefully release the outer circle of the springform tin and return the pie to the oven for another 20–25 minutes, or until the sides are nicely colored and everything is golden and bubbling.
                Leave to settle for 15 minutes.
                Top the pie with roughly chopped parsley (1 tbsp) and lemon zest (1½ tsp) and serve warm.'
)
...
aubergine_with_buttermilk_sauce = Recipe.create!(
  ...
  instruction: 'Preheat the oven to 200°C/Gas Mark 6.
                ...
                Place the aubergine halves, cut-side up, on a baking sheet lined with baking parchment.
                Brush them with the olive oil – keep on brushing until all of the oil has been absorbed by the flesh.
                Sprinkle with the lemon thyme leaves and some salt and pepper.
                Roast for 35–40 minutes, at which point the flesh should be soft, flavorsome, and nicely browned.
                Remove from the oven and allow to cool down completely.
                While the aubergines are in the oven, prepare the pomegranate and sauce. Cut the pomegranate into two horizontally.
                ...
                To serve, spoon plenty of buttermilk sauce over the aubergine halves without covering the stalks.
                Sprinkle za’atar and plenty of pomegranate seeds on top and garnish with lemon thyme. Finish with a drizzle of olive oil.'
)
...
spicy_mushroom_lasagne = Recipe.create!(
  ...
  instruction: 'Preheat the oven to 230°C fan.
                ...
                Toss the chopped mushrooms in a large bowl with 3 tablespoons of oil and 1 teaspoon of salt and spread out on a large, 40cm x 35cm parchment-lined, rimmed baking tray.
                ...
                Meanwhile, combine the dried mushrooms, chillies, and hot stock in a large bowl and set aside to soak for half an hour.
                ...
                Very roughly chop the rehydrated mushrooms (you want some chunks) and finely chop the chillies.
                Set the stock and mushrooms aside separately.
                Put the onion, garlic, and carrot into the food processor and pulse until finely chopped (or finely chop everything by hand).
                Heat 60ml of oil in a large sauté pan or pot on a medium-high heat.
                ...
                Drizzle over 1 tablespoon of cream and 1 tablespoon of oil, then cover with foil and bake for 15 minutes.
                ...
                Sprinkle over the remaining parsley, finish with a good grind of pepper and serve.'
)
...
puy_lentil_aubergine_stew = Recipe.create!(
  ...
  instruction: 'Put 2 tablespoons of olive oil into a large, high-sided sauté pan and place on a medium-high heat.
  Add the finely sliced garlic, finely chopped red onion, picked thyme leaves, and ¼ teaspoon of salt. Fry for 8 minutes, stirring often, until soft and golden.
  Tip into a bowl, leaving the oil behind. Set aside.
                Place the aubergines and cherry tomatoes in a bowl and season with ¼ teaspoon of salt and plenty of pepper.
                Add the remaining oil to the same pan (don’t worry about wiping it clean) and, once very hot, add the aubergines and tomatoes.
                ...
                Return the garlic and onion mixture to the pan, then add the Puy lentils, vegetable stock, dry white wine, 450ml of water, and ¾ teaspoon of salt.
                Bring to the boil. Lower the heat to medium and simmer gently for about 40 minutes, until the lentils are soft but still retain a bite.
                Serve warm or at room temperature with a dollop of crème fraîche, a drizzle of olive oil, and sprinkled with Urfa chilli flakes (or regular chilli flakes) and picked oregano leaves on top.',
)

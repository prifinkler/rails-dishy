...
pappardelle_recipe = Recipe.create!(
  ...
  instruction: 'Heat olive oil in a large sauté pan with a lid over medium-high heat.
                ...
                Add 200ml of water and stir. Bring to a boil, then reduce the heat to medium-low, cover, and simmer for 10 minutes.
                Remove the lid and continue to cook for 4–5 minutes, until the sauce is thick and rich. Stir in 10g of parsley and set aside.
                In a large pot, boil salted water and cook the pappardelle according to the packet instructions until al dente. Drain well.
...
koftas_recipe = Recipe.create!(
  ...
  instruction: 'Put the chicken thighs in a food processor and pulse until minced.
                ...
                Make the rub by combining finely ground coffee, ground cascabel chilli, soft light brown sugar, smoked paprika, and ground cumin with 1/2 tsp salt. Set aside one-third of the rub mixture and spread the rest over a baking tray. Roll each kofta in the coffee rub until well coated and set aside (or refrigerate if preparing ahead).
                Preheat the oven to 240°C (220°C fan)/475°F/gas Toss the red onion rounds with 1 tbsp oil, 1/4 tsp salt, and pepper. Grill the onion slices in a well-greased griddle pan on a high heat for four minutes on each side until well charred and softened, then set aside to cool.
...
jollof_rice_recipe = Recipe.create!(
  ...
  instruction: 'Put all the puree ingredients in a food processor, except the scotch bonnets, if using whole, and whizz into a thick and aromatic puree.
                ...
                Gently pour in the blended puree, stirring well, then cover and cook for up to 25 minutes, until the puree is reduced to a drier sauce. Keep a close eye on it and stir occasionally.
...
scully_pork_belly = Recipe.create!(
  ...
  instruction: "Heat the oven to 250°C/Gas Mark 10 or its highest setting.
                ...
                Lay the pork belly in an oven tray, skin-side down, and lightly sprinkle with salt and pepper. Spread the herb mixture evenly over the top, pressing it onto the meat.
                Turn the belly skin-side up, dry the skin with kitchen paper, and sprinkle sea salt evenly over the skin (avoid using too much). Place the tray in the oven and roast for 1 hour, turning it every 20 minutes.
                Once the skin starts forming crackling, reduce the oven temperature to 170°C/Gas Mark 3, pour the white wine into the tray (avoiding the pork skin), and continue roasting for another hour. If the belly starts turning black, cover it with foil.
                ...
                Remove the pork from the oven. Use a sharp knife to divide it into segments of a few ribs, cutting between the rib bones. Serve with seasonal relishes on the side."
)
...
lamb_pistachio_patties = Recipe.create!(
  ...
  instruction: 'Mix together Greek-style yogurt, sumac, olive oil, and lemon juice. Keep in the fridge until needed.
                ...
                Heat 1 tablespoon of olive oil in a large nonstick frying pan over medium heat. Cook the patties for 7 minutes, turning about 3 1/2 minutes, until golden brown and cooked through. Keep warm while cooking the remaining patties. Add more oil if needed.
...
curried_cauliflower_pie = Recipe.create!(
  ...
  instruction: 'Preheat the oven to 180°C fan. Line the bottom and sides of a 23cm springform cake tin with baking parchment.
                ...
                Spoon half the béchamel into the base and top with the roasted cauliflower florets. Spoon over the remaining béchamel, then crimp up the overhang so that it creates a messy ‘scrunched-up’ border around the edges, leaving the center of the pie exposed.
                ...
                Using a tea towel to help you, carefully release the outer circle of the springform tin and return the pie to the oven for another 20–25 minutes, or until the sides are nicely colored and everything is golden and bubbling. Leave to settle for 15 minutes.
...
puy_lentil_aubergine_stew = Recipe.create!(
  ...
  instruction: 'Put 2 tablespoons of olive oil into a large, high-sided sauté pan and place on a medium-high heat. Add the finely sliced garlic, finely chopped red onion, picked thyme leaves, and ¼ teaspoon of salt. Fry for 8 minutes, stirring often, until soft and golden. Tip into a bowl, leaving the oil behind. Set aside.
                Place the aubergines and cherry tomatoes in a bowl and season with ¼ teaspoon of salt and plenty of pepper. Add the remaining oil to the same pan (don’t worry about wiping it clean) and, once very hot, add the aubergines and tomatoes. Fry for 10 minutes on medium-high, turning them often until the aubergine is soft and golden-brown and the tomatoes are beginning to blacken.
                Return the garlic and onion mixture to the pan, then add the Puy lentils, vegetable stock, dry white wine, 450ml of water, and ¾ teaspoon of salt. Bring to the boil. Lower the heat to medium and simmer gently for about 40 minutes, until the lentils are soft but still retain a bite.
